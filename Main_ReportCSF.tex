...
\begin{center}
    ...
    \mbox{}\\[2.0cm]
    \textsc{\Huge MEEC}\\[2cm]
    \textsc{\LARGE Comunicações sem Fios}\\[2.0cm]
    \HRule\\[0.4cm]
    {\large \bf {Análise de cobertura e qualidade de sinal em sistemas wireless com e sem diversidade na recepção na 
presença de modulações multi e mono-portadora.}}\\[0.2cm] % [\texttt{EN}]
    \HRule\\[1.5cm]
\end{center}
...
\subfile{Sections/SistemImplementado.tex}
\subfile{Sections/Resultados.tex}
\subfile{Sections/Conclusões.tex}
